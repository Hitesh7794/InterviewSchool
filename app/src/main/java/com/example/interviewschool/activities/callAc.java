...
import com.example.interviewschool.databinding.ActivityCallBinding;
...
import com.example.interviewschool.models.InterfaceJava;
            ...
            FirebaseDatabase.getInstance().getReference()
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                            ...
                            Glide.with(callAc.this).load(user.getProfile())
