...
import com.example.interviewschool.databinding.ActivityMainBinding;
        ...
        nav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.home:
                        startActivity(new Intent(MainActivity.this,OptionsAc.class));
                        break;
                    case R.id.person:
...
//                        progress.dismiss();
                ...
                if(isPermissionsGranted()) {
                    if (coins > 10) {
                        ...
                        database.getReference().child("profiles")
                                ...
                                .child("coins")
                                .setValue(coins);
                        Intent intent = new Intent(MainActivity.this, ConnectingAc.class);
        ...
        binding.rewardBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, RewardAc.class));
            }
        });
