...
import com.example.interviewschool.databinding.ActivityRewardBinding;

public class RewardAc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.video1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mRewardedAd != null) {
                    Activity activityContext = RewardAc.this;
