...
import com.example.interviewschool.R;
import com.example.interviewschool.databinding.ActivityConnectingBinding;
...
public class ConnectingAc extends AppCompatActivity {
                        ...
                        if(snapshot.getChildrenCount() > 0) {
                            ...
                            for(DataSnapshot childSnap : snapshot.getChildren()) {
                                ...
                                database.getReference()
                                        ...
                                        .child("status")
                                        .setValue(1);
                                Intent intent = new Intent(ConnectingAc.this, callAc.class);
