...
public class LoginAc extends AppCompatActivity {
    ...
    void goToNextActivity() {
        startActivity(new Intent(LoginAc.this, splashAc.class));
        finish();
    }
                            ...
                            database.getReference()
                                    ...
                                    .setValue(firebaseUser).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull @NotNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                startActivity(new Intent(LoginAc.this, OptionsAc.class));
                                                finishAffinity();
                                            } else {
                                                Toast.makeText(LoginAc.this, task.getException().getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
